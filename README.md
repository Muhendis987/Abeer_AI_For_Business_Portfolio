...
Throughout these projects, Generative AI served as an intelligent development assistant and workflow accelerator. I utilized Large Language Models(LLMs) for rapid code generation, debugging syntactical errors, and brainstorming optimization strategies for hyperparameter tuning. Additionally, I engaged generative tools to quickly synthesize data for edge-case testing, which vastly improved model robustness and reduced the friction of traditional exploratory research.<br>
